...
//!               or clearing the RAMPZ register).
//!
//! @param: src      Pointer on source buffer (in SRAM).
//!         dest     Destination, start address value in Flash memory where data
//!                  must be written.
//!         byte_nb  Number of bytes to write.
//!
//! @return none
//------------------------------------------------------------------------------
//#pragma location ="API_FLASH"
