...
#define     _FARFLASH_TYPE_     _progmem_far
...
#define     Flash_fill_temp_buffer(addr, data_w)  { boot_page_fill(addr, data_w); }
#define     Flash_page_write(page_addr)           { boot_page_write(page_addr)  ; }
//#define     Flash_page_erase(page_addr)           { _SPM_ERASE((void _FLASH_TYPE_*) page_addr)      ; }
#define     Flash_page_erase(page_addr)           { boot_page_erase(page_addr)      ; }
...
#define     Farflash_rd_byte(addr_byte)           ( pgm_read_byte_far(addr_byte) )
#define     Farflash_rd_word(addr_word)           ( pgm_read_word_far(addr_word) )

#define     Flash_rww_section_enable              { boot_rww_enable() ; }
